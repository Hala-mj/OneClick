...
document.addEventListener('DOMContentLoaded', () => {
        ...
        if (files.length > 0 && selectedScreens.length > 0) {
            selectedScreens.forEach(screen => {
                ...
                for (const file of files) {
                    ...
                    mediaElement.style = 'max-width: 100%; height: auto; display: block;';
            ...
            alert('Please select at least one screen and import media');
        }
    });
    ...
    fileInput.setAttribute('accept', 'image/*,video/mp4');
